...
class Customer_Test extends WP_UnitTestCase {
	...
	public function test_verification_key_functionality(): void {
		...
		$verification_key = $customer->get_verification_key();

		$this->assertSame(32, strlen($verification_key));
		$this->assertMatchesRegularExpression('/^[A-Za-z0-9]+$/', $verification_key);
